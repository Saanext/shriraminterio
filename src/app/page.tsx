...
import { Award, Briefcase, Users, Video, Smartphone, CircleDollarSign } from 'lucide-react';
      ...
      <section id="expertise" className="py-16 md:py-24 bg-secondary">
        <div className="container mx-auto px-4">
           <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold">Why Choose Shriram Interio?</h2>
            <p className="text-lg text-muted-foreground mt-2">We blend artistry with functionality to create spaces that are not only beautiful but also a true reflection of you. <br /> Our commitment to quality and customer satisfaction is at the heart of everything we do.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {expertise.map((item) => (
              <Card key={item.title} className="text-center p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
